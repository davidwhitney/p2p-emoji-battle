...
import { assertConfiguration, ChannelParameters } from "@ably-labs/react-hooks/src/AblyReactHooks";
...
export function useChannel(channelNameOrNameAndOptions: ChannelParameters, ...channelSubscriptionArguments: any[]): ChannelAndClient {
    ...
    // NOTICE THE ABOVE LINE HAS EXTRA CHANNELSUBSCRIPTION ARGUMENTS ADDED TO THE USEEFFECT
    // THIS IS IMPORTANT :)
